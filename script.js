var tmusic = ['ll.mp3','Hunter.mp3','Jifuragi.mp3','Night Of Sicily.mp3','Un diavolo scaccia l′altro.mp3','Code.mp3','sunshine.mp3','code.mp3','king.mp3','king2.mp3','ring.mp3','FT1.mp3','pre.mp3','kanata.mp3','OOK.mp3','dd.mp3','lemon.mp3','peace.mp3','sisyphus.mp3','it.mp3','stb.mp3','RH.mp3','lisa2.mp3','AD.mp3','DS1.mp3','DS2.mp3','BC.mp3','AL.mp3'];
var tmusicname = ['무법 변호사 Lawless Lawyer Main Title','Hunter x Hunter','Jifuragi','Night Of Sicily','Un diavolo scaccia l′altro','Code Gease',"미스터 션샤인 Mr. Sunshine (Viola. 리처드 용재 오닐 Richard Yongjae O'Neill)",'The Da Vinci Code',"The King's Avatar - 全职高手  「Extended OP」Xin Yang BY -Zhang Jie","The King's Avatar Ost Full Album",'JJ Lin – Lose Control _ Shang-Chi - The Album','FairyTail Main Theme OP1','Official髭男dism - Pretender','Haruka Kanata','ONE OK ROCK - The Beginning (Road to Rurouni Kenshin The Final 2020)','Durarara!! Opening 1','米津玄師  - Lemon  Kenshi Yonezu','米津玄師 - ピースサイン , Kenshi Yonezu - Peace Sign','Sisyphus_ The Myth OST Part 1 [시지프스 OST Part 1]','시작 - Itaewon Class Main Theme','그때 그 아인 (Someday, The Boy)','Rising Hope - LiSA','『炎』- LiSA','Absolute Duo - Opening - [Legendado]','Official髭男dism - 115 man Kilo no Film','『Cry Baby』by Official HIGE DANdism','ビッケブランカ - Black Catcher - Vicke Blanka','IRIS (アイリス) - Aoi Eir'];
var tmusicpic = ['ll.png','Hunter.jpg','v3.jpg','v2.jpg','v1.jpeg','Code.jpg','sunshine.jpg','code.jpg','king.jpg','king2.jpg','ring.jpg','FT1.jpeg','pre.png','kanata.jpg','OOK.png','dd.png','lemon.jpg','peace.jpg','sisyphus.jpg','it.webp','stb.jpg','lisa.webp','lisa2.png','AD.jpg','DS1.jpg','DS2.jpg','BC.jpg','AL.jpg'];

var music = ['royal.mp3','kino.mp3','elena.mp3','detective.mp3','irregular.mp3','vanitas.mp3','jorm.mp3','crusade.mp3','hero.mp3','world.mp3','magi.mp3','over.mp3','seven.mp3','spare.mp3','nogame.mp3','bs.mp3'];
var musicname = ["Oushitsu Kyoushi Haine Ending FULL - Doko ni Ita no sa!～Prince Night ／ P4 with T「王室教師ハイネ ED」","Kino's Journey -the Beautiful World- Ending _ Satodama no Tsuki","Wandering Witch: The Journey of Elaina","The Detective is Already Dead","The Irregular at Magic High School","ヴァニタスの 手記 カルテ (Vanitasu no Karute)","Jormungand (ヨルムンガンド, Yorumungando)","Our Last Crusade or the Rise of a New World","The Legendary Hero's","World End","Magi Opening 2","Overlord Season 3 – Opening Theme – Voracity",'Seven Deadly Sins Opening 1 Netsujou no Spectrum','大王饶命 opening 1','ノーゲーム・ノーライフ opening 1','Black Summoner Op 1'];
var musicpic = ["royal.jpg","kino.png","elena.jpg","detective.jpg","irregular.jpg","vanitas.jpg","jorm.jpg","crusade.jpeg",'hero.jpg','world.jpeg','magi.jpg','over.jpg','seven.jpg','spare.png','nogame.png','bs.jpeg'];
var pre = [];
var m1 = false;
var logins = false;
var mute1 = false;
...
function openpre() {
  ...
  else { document.getElementById('prem').style.display = "none";document.getElementById('loop').style.display = 'block';
        preopen = 0;
  }
}
function changer3() {
...
function menu() {
 ...
 pause(); document.getElementById('login').style.display = 'block';
   document.getElementById('slidecov').style.display = 'none';
  document.getElementById('loop').style.display = 'none';
