...
var music = ['royal.mp3','kino.mp3','elena.mp3','detective.mp3','irregular.mp3','vanitas.mp3','jorm.mp3','crusade.mp3','hero.mp3','world.mp3','magi.mp3','over.mp3','seven.mp3','spare.mp3','nogame.mp3'];
var musicname = ["Oushitsu Kyoushi Haine Ending FULL - Doko ni Ita no sa!～Prince Night ／ P4 with T「王室教師ハイネ ED」","Kino's Journey -the Beautiful World- Ending _ Satodama no Tsuki","Wandering Witch: The Journey of Elaina","The Detective is Already Dead","The Irregular at Magic High School","ヴァニタスの 手記 カルテ (Vanitasu no Karute)","Jormungand (ヨルムンガンド, Yorumungando)","Our Last Crusade or the Rise of a New World","The Legendary Hero's","World End","Magi Opening 2","Overlord Season 3 – Opening Theme – Voracity",'Seven Deadly Sins Opening 1 Netsujou no Spectrum','大王饶命 opening 1','ノーゲーム・ノーライフ opening 1'];
var musicpic = ["royal.jpg","kino.png","elena.jpg","detective.jpg","irregular.jpg","vanitas.jpg","jorm.jpg","crusade.jpeg",'hero.jpg','world.jpeg','magi.jpg','over.jpg','seven.jpg','spare.png','nogame.png'];
var pre = [];
var m1 = false;
var logins = false;
var mute1 = false;
